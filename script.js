(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.body.addEventListener('click', function(e) {
      ...
      var header = document.querySelector('.navbar, .header, header');
    ...
    var navbar = document.querySelector('.navbar, .header, header');
    ...
    if (contactForm) {
      var showError = function(input, message) {
        ...
        error.style.cssText = 'color:#e74c3c;font-size:0.85em;margin-top:4px;display:block;';
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
          ...
          setTimeout(function() {
            ...
            successMsg.style.cssText = 'color:#27ae60;margin-top:16px;font-weight:600;';
    ...
    var animatedElements = document.querySelectorAll('.fade-in, .animate-on-scroll, [data-animate]');
    ...
    if (animatedElements.length > 0) {
      ...
      style.textContent = '.fade-in.visible,.animate-on-scroll.visible,[data-animate].visible{opacity:1!important;transform:translateY(0)!important}';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ad697662-dda6-4e55-a41d-e1caf8899ac2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ad697662-dda6-4e55-a41d-e1caf8899ac2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ad697662-dda6-4e55-a41d-e1caf8899ac2';
